      ...
      <header className="w-full border-b border-white/50 bg-white/60 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-extrabold tracking-tight text-slate-700">portlyfolio.site</h1>
          </Link>
      ...
      <footer className="w-full border-t border-slate-200/60 py-8 bg-white/40">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 opacity-50">
            ...
            <span className="text-sm font-bold text-slate-600">portlyfolio.site &copy; {new Date().getFullYear()}</span>
          </div>
